...
$\mathcal{Min-Max}$ Ant System ($\mathcal{MMAS}$). Sua principal intenção
...
forma o algoritmo encerava a busca quando encontrar um valor determinado,
...
A Linha \ref{ant-blocal} de \proc{QAP-MMAS}, aplica a busca local {\it
2OPT} a solução de todas as formigas.
